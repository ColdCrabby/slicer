...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::library_save_settings,
            commands::library_scan,
            commands::library_import_paths,
            commands::library_import_bytes,
            commands::library_resolve,
            commands::library_touch,
            commands::library_rename,
            commands::library_remove,
            commands::library_thumbnail,
            commands::library_set_thumbnail,
            commands::library_models_dir,
