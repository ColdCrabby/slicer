...
| `thumbnail_enabled`       | bool | `true`    | true/false                          | Embed a PNG thumbnail comment block in output G-code           |
...
| `thumbnail_theme`         | enum | `light`   | light/dark                          | Fixed thumbnail colour scheme (independent of app/OS theme)    |
