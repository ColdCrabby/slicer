...
**Not sure what to click after a change?** Ask the agent "what should I test?" — the [`test-changes` skill](.github/skills/test-changes/SKILL.md) turns the diff into a short checklist for the surface you name (remote + web by default, or the wasm slicer, desktop app, or iPad).
